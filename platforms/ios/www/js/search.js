...
class Search {
  ...
  FormGenerator(){
    ...
    $.ajax({
      ...
      Connector_Desc_1            = response['technical_spec'].Connector_Desc_1;
      Connector_Desc_2            = response['technical_spec'].Connector_Desc_2;
