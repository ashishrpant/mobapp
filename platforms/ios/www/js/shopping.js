...
class Shopping {
  ...
  ViewCart() {
    ...
    shopping_cart_foot = '<div class="shopping_cart--sn"><strong>Total $</strong> ' + sub_total + '</div> ' +
      '<div>&nbsp;</div><div class="btn-group" role="group" aria-label="Cart Actions">' +
      ...
      '<button type="button" class="btn btn-primary" onclick="Shopping.PreviewOrder()">Proceed To Checkout <i class="fa fa-angle-right"></i></button>' +
      '</div>';
